import { Trash2, AlertCircle, X, Loader2, FileText } from "lucide-react";
...
const DeleteAgreementModal = ({ isOpen, onClose, onConfirm, isLoading }: Props) => {
      ...
      <div className="bg-white dark:bg-slate-800 rounded-[32px] shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-300">
        ...
        <div className="px-8 pb-8 text-center space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-black text-slate-800 dark:text-slate-100">চুক্তিপত্র মুছে ফেলুন</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
              আপনি কি নিশ্চিত যে এই ডিজিটাল চুক্তিপত্রটি মুছে ফেলতে চান?
            </p>
          </div>
          ...
          <div className="flex items-start gap-3 p-4 bg-slate-50 dark:bg-slate-700/50 rounded-2xl text-left">
            ...
            <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
              সতর্কতা: এটি মুছে ফেললে ভাড়াটিয়া আর চুক্তিটি দেখতে পাবে না এবং তার স্বাক্ষরও মুছে যাবে। আপনাকে পুনরায় চুক্তি জেনারেট করতে হবে।
            </p>
          </div>
