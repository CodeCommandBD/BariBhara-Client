    ...
    <div className="space-y-8 p-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">সব বকেয়া এবং পেন্ডিং বিল ম্যানেজ করুন</p>
        </div>
        <button
          onClick={handleSendReminders}
          disabled={sendingReminder}
          className="flex items-center gap-2 px-5 py-3 bg-amber-500 text-white font-bold rounded-2xl shadow-lg shadow-amber-200 hover:scale-105 transition-all disabled:opacity-50"
        >
          {sendingReminder ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <StatusCard
          ...
          label="মোট বকেয়া বিল"
          value={pendingInvoices.length}
          bg="bg-orange-50"
        />
        <StatusCard
          icon={<AlertCircle className="text-red-500" />}
          label="সর্বমোট বকেয়া টাকা"
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50/50">
                  <th className="p-5 text-[10px] font-black text-slate-400 uppercase tracking-wider">ভাড়াটিয়া ও ইউনিট</th>
                  ...
                  <th className="p-5 text-[10px] font-black text-slate-400 uppercase tracking-wider">বকেয়া (Due)</th>
                        ...
                        <div className="flex items-center justify-end gap-2">
                          {inv.tenant?.email && (
                            <button
                              ...
                              className="p-2 bg-amber-50 text-amber-500 hover:bg-amber-100 rounded-xl transition-all"
                            >
                              <Mail size={15} />
                            </button>
                          )}
