        ...
        <div className="hidden lg:flex lg:w-1/2 relative bg-surface-container overflow-hidden items-center justify-center p-12">
          ...
          <div className="relative z-20 max-w-lg space-y-8 p-12 rounded-xl bg-white/20 backdrop-blur-xl border border-white/30 shadow-2xl">
            <h1 className="font-headline text-5xl font-extrabold tracking-tight text-white leading-tight drop-shadow-md text-center">
              আবারও স্বাগতম <br /><span className="text-primary-fixed drop-shadow-sm italic">Bari Bhara-এ</span>
            </h1>
            <p className="text-white text-lg leading-relaxed font-medium drop-shadow-sm text-center">
              আপনার সঠিক ঠিকানা খুঁজে পেতে এবং পরিচালনা করতে লগইন করুন। বাংলাদেশের সবচেয়ে নিরাপদ রেন্টাল কমিউনিটিতে প্রবেশ করুন।
            </p>
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-4 text-white drop-shadow-sm">
                <span className="material-symbols-outlined bg-primary/40 p-2 rounded-full">key</span>
                <span className="font-semibold font-headline">নিরাপদ এবং এনক্রিপ্টেড লগইন</span>
              </div>
              <div className="flex items-center gap-4 text-white drop-shadow-sm">
                <span className="material-symbols-outlined bg-primary/40 p-2 rounded-full">bolt</span>
                <span className="font-semibold font-headline">দ্রুত এবং নিরবিচ্ছিন্ন এক্সেস</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 bg-surface-container-high flex items-center justify-center p-8 overflow-y-auto">
          <div className="w-full max-w-md space-y-10">
            <div className="space-y-3">
              ...
              <p className="text-on-surface-variant font-medium">আপনার তথ্য দিয়ে Bari Bhara-এ প্রবেশ করুন।</p>
            </div>
            ...
            <form className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="group">
                  <div className="flex justify-between items-center mb-2 px-1">
                    <label className="text-sm font-semibold text-on-surface-variant italic">পাসওয়ার্ড</label>
                    <Link className="text-xs font-bold text-primary hover:underline" to="/forgot-password">পাসওয়ার্ড ভুলে গেছেন?</Link>
                  </div>
                  <div className="relative">
              ...
              <div className="flex items-center gap-2 px-1">
                <input id="remember" type="checkbox" className="rounded-sm border-gray-300 text-primary focus:ring-primary cursor-pointer" />
            ...
            <p className="text-center text-on-surface-variant font-headline">
              অ্যাকাউন্ট নেই? <Link className="text-primary font-bold hover:underline" to="/register">নতুন অ্যাকাউন্ট খুলুন</Link>
            </p>
          </div>
        </div>
      </main>
